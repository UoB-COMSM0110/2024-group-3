...
1. Download and extract the following ZIP file: [game_download_file](https://github.com/UoB-COMSM0110/2024-group-3/blob/develop/download/game_download_file.zip)
